...
public class UserTokenCacheUtil {
	...
	public static void addUserInfoCache(CacheManager cacheManager,String token,UserSimple us,Boolean isRepeatLogin ){
		...
		//增加用户缓存
		addUserInfoCache(cacheManager, token, us, user_token_key,isRepeatLogin);
	 ...
	 * @param us
	 */
	private static void addUserInfoCache(CacheManager cacheManager,String token,UserSimple us,String user_token_key,Boolean isRepeatLogin){
