...
public class SCard implements Serializable{
    ...
    public SCard(Long id, Long batchid, String cardnumber, String cardpwd, Date createtime, String createman, Long roleid, String registkeytype, Date starttime, Date endtime, Integer state, Integer expNum, String section, Long positionid, Long dispositionid, Boolean flag, Integer count, Long cityid, Long provinceid) {
        this.id = id;
     ...
     *
     * @param registkeytype 注册码类型 （教师客户端M，还是网络注册账号P，充值卡类型）
     */
     ...
     *
     * @param expNum 注册期限（这卡必须在什么时间注册，过期则视为无效卡）多少个月
     ...
     * 设置标明卡号的位置定位到学校还是区县
     *
     * @param positionid 标明卡号的位置定位到学校还是区县
     */
