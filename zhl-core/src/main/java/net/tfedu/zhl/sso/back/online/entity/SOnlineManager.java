package net.tfedu.zhl.sso.back.online.entity;

import java.util.Date;
import javax.persistence.*;

@Table(name = "s_online_manager")
public class SOnlineManager {
    /**
     * ID
     */
    @Id
    ...
    public SOnlineManager(Long id, Long userid, Date logintime, Long loginnodeid, Date lastopertime, Integer clienttype, String deviceinfo, Integer status, String loginip, String clientversion, Boolean flag, String token) {
        this.id = id;
        this.userid = userid;
     ...
     *
     * @param clienttype 1 web 2 android 3 winpad
     */
     ...
     *
     * @param status 状态 1 在线 2 退出 3 超时 4 被踢出
     */
