...
public class JUserlog {
    ...
    public JUserlog(Long id, Long userid, String logtypecode, String opertypecode, String objname, Long objid, Long subjectid, Date createtime, String duration, Boolean downflag, Integer alltestnum, Integer corrtestnum, Boolean flag, Integer isflag) {
        this.id = id;
        this.userid = userid;
