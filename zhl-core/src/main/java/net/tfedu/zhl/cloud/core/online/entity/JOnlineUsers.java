...
public class JOnlineUsers {
    ...
    public JOnlineUsers(Long id, Long userid, Date logintime, Long loginnodeid, Date lastopertime, Integer clienttype, String deviceinfo, Integer status, String loginip, String clientversion, Boolean flag, String token) {
        this.id = id;
        this.userid = userid;
