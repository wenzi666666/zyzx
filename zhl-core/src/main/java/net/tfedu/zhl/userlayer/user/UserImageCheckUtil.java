...
public class UserImageCheckUtil {
	...
	public static String checkUserImage(String userImage, CommonWebConfig commonWebConfig, HttpServletRequest request) {
		...
		if (userImage != null &&
				...
				!userImage.trim().startsWith("http")
//				(userImage.trim().contains(ZhlResourceCenterWrap.userimage_upload_prefix)
//						||
//						userImage.trim().contains(ZhlResourceCenterWrap.userimage_upload_prefix_default)
//						
//						)
			) {
