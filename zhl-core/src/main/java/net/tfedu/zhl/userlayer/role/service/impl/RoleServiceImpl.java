package net.tfedu.zhl.userlayer.role.service.impl;
...
import net.tfedu.zhl.userlayer.role.dao.JUserRoleMapper;
import net.tfedu.zhl.userlayer.role.entity.JRole;
import net.tfedu.zhl.userlayer.role.entity.JUserRole;
