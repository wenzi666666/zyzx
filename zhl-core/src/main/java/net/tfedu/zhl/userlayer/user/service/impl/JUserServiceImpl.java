package net.tfedu.zhl.userlayer.user.service.impl;
...
import net.tfedu.zhl.userlayer.funclist.dao.FuncListMapper;
import net.tfedu.zhl.userlayer.funclist.entity.FuncListSimple;
import net.tfedu.zhl.userlayer.role.dao.JRoleMapper;
...
import net.tfedu.zhl.userlayer.user.entity.JUserTeachingQueryEntity;
