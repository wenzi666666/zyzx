...
import net.tfedu.zhl.cloud.casProxy.model.IpInfoEntity;
import net.tfedu.zhl.cloud.utils.datatype.StringUtils;

import com.alibaba.fastjson.JSON;

/**
 * 根据IP地址获取详细的地域信息 copyRight@知好乐教育技术北京有限公司
 * 
 * @author jiys
 * @date 2016-12-8
 * @version v1.0.0
...
public class AddressUtils {
	...
	public static String encodingString="UTF-8";
	 ...
	 */
	public static AddressEntity getAddresses(String ip)
			throws UnsupportedEncodingException {
		ip="ip="+ip;
		// 这里调用pconline的接口
		...
		if (StringUtils.isNotEmpty(returnStr)) {
			IpInfoEntity ipInfoEntity=JSON.parseObject(returnStr, IpInfoEntity.class);
			addressEntity=ipInfoEntity.getData();
		}
...
//			address = addressUtils.getAddresses("ip=" + ip, "utf-8");
			AddressEntity addressEntity = addressUtils.getAddresses("ip=" + ip);
