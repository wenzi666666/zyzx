...
*/
@Component
public class CasProxyCustomBase {
	
	Logger log = LoggerFactory.getLogger(CasProxyCustomBase.class);
	 ...
	 * @throws Exception
	 */
	public void login(HttpServletRequest request, HttpServletResponse response,ProxyService proxy) throws CustomException, Exception {
		...
		log.info("----parseAPI-----with----" + proxy.getClass().getName());

		RegisterAddForm form = proxy.parseAPI(request, casConfig);
