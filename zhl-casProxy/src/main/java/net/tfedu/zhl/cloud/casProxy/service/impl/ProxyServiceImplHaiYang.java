...
*/  
@Service("proxyServiceHaiyang")
public class ProxyServiceImplHaiYang  implements ProxyService{
	
	
	Logger log = LoggerFactory.getLogger(ProxyServiceImplHaiYang.class);
	...
	public RegisterAddForm parseAPI(HttpServletRequest request, ThirdPartyCASConfig config) throws CustomException{
		...
		String cityName = "烟台市";
		String districtName = "海阳市";
		String Default_schoolName = "海阳市测试学校";
		String schoolName = "";
		...
		form.setUserName(info.getLogin_name());
