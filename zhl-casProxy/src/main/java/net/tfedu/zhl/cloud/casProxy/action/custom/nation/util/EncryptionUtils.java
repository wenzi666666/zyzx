...
public class EncryptionUtils {
	...
	public static String bytesToHexString(byte[] src) {
		/**
		 * for (int i = 0; i < src.length; i++) { System.out.println(src[i]); }
		 **/
	...
	public static void main(String[] args) {
		/**
		 * String appid = "7cc1ff8873cb4d18b92f74557ae2af6b"; String appkey =
		 * "35b000513b404a64870a795090f097f5"; String timestamp =
		 * "1382446117182"; String digest = bytesToHexString(getHmacSHA1(
		 * appid+appkey+timestamp, appkey) System.out.println(digest);
		 **/

		System.out.println(System.currentTimeMillis());

		String appid = "AP000000015262";
		String appkey = "be44b02fba64442631c8b45399b51a49";
