...
public class CasProxyCustomNation extends CasProxyCustomBase {
	...
	public String login(String ticket,String sysCode,HttpServletRequest request, HttpServletResponse response) throws CustomException, Exception {
		...
		String _url = casConfig.getTARGET_REDIRECT_URL() + "?userName="+userName+"&dockingCode="+thirdCode
				+"&appId="+zhlApp.getAppid()+"&timestamp="+timestamp
				+"&sign="+sign;
