...
public interface JPrepareContentMapper extends CoreMapper<JPrepareContent> {
	 ...
	 * @return
	 */
	public List<JPrepareContentView> getPrepareContentListByUserId(@Param("userId")Long userId,@Param("unifyTypeId")Long unifyTypeId,@Param("fileFormat")String fileFormat); 
