...
public class PrepareController {
    ...
    @ResponseBody
    public ResultJSON querPrepareContent(@PathVariable Long prepareId, HttpServletRequest request,
    ...
    @ResponseBody
    public ResultJSON addPrepareContent(@PathVariable Long prepareId, HttpServletRequest request,
            HttpServletResponse response) {
        // 返回json的结果对象
        ResultJSON result = new ResultJSON();
        // 异常
