...
public class Base64 {
    ...
    //64转换
    public static String doEncoding64(String s) throws UnsupportedEncodingException{
    	s = URLEncoder.encode(s,"utf-8");
    	return Base64.encode(s.getBytes(), 0, s.length());
    }
    public static String doEncoding64(String[] s,String separator){
    	String target = "";
    	...
    	try {
			return doEncoding64(target);
		} catch (UnsupportedEncodingException e) {
			return null ;
		}
    }    
    public  static String doDecoding64(String target) {    	
    	try {
//			return  new String(Base64.decode(URLDecoder.decode(target,"utf-8")));
    		return  URLDecoder.decode(new String(Base64.decode(target)), "utf-8");
		} catch (IOException e) {
			return  null ;
		}
    }
    ...
    public static  String[] doDecoding64(String target,String separator) throws UnsupportedEncodingException, IOException {    	
    	String t = new String(Base64.decode(target),"utf-8");
    	if(t.indexOf(separator)>=0){
    		return t.split(separator);
    	}else{
        	String s = URLEncoder.encode(separator,"utf-8");
    		return t.split(s);
    	}
    }
    
    public static  Map<String, String> doDecoding64(String target,String separator,String separator2) throws UnsupportedEncodingException, IOException {    	
    	 Map<String, String>  map = null;
    	 String[] array1 = doDecoding64(target, separator);
    	 if(array1!=null && array1.length>0){
    		 map=new HashMap<String, String>();
    		 for (String string : array1) {
    			 String s = URLEncoder.encode(separator2,"utf-8");
    			 String[] array2 = string.split(s);
    ...
    public static void main(String [] args){
    	String s = "changjaing";
    	String t = "JUU2JTg4JTkxJUU3JTlBJTg0JUU1JUFEJUE2JUU1JThGJUI3JTNG";
    	String c = "%E6%88%91%E7%9A%84%E5%AD%A6%E5%8F%B7%3F";
//    	
//    	String s = "userCode=lanfeng&password=000";
//    	String t = "bGluamluZzEIMOEwMDAwMDAIMOEIOTMIMOEw";
    	try {
    		System.out.println(Base64.doEncoding64("zqxuqiong:000000"));
    		System.out.println(Base64.doEncoding64("zqxuqiong:000000"));
//			System.out.println(Base64.doDecoding64(t));
//			String temp =  URLDecoder.decode(new String(Base64.decode(t)), "utf-8");
...
//        	String [] str = new String[]{"tfedu","id","name"};
//    		String s1 = Base64.doEncoding64(str, "_");
//    		System.out.println(s1);
//    		System.out.println(Base64.doDecoding64(s1));
