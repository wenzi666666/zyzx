...
public class XPlatFormShare {
	...
	public XPlatFormShare(Long id, String studycourseid, Integer sharedtype, Long shareid, String scope, Long scopeid,
			Long userid, Date createtime, Integer clicks, Integer quotes, Integer downloads, Boolean flag,
			Long sysresourcetype,Integer  intergral) {
		this.id = id;
	...
	public Integer getIntergral() {
		return  null == intergral ? 0 : intergral;
	}
	...
	public void setIntergral(Integer intergral) {
		this.intergral =  null == intergral ? 0 : intergral;
	}
