...
import net.tfedu.zhl.cloud.core.role.entity.JRole;
import net.tfedu.zhl.cloud.core.school.entity.JSchool;
...
public class JUser   implements Serializable{
    ...
    public JUser(Long id, String name, String roleid, Long channelid, Long channellimit, Date logintime, Date logouttime, Long schoolid, String truename, String nickname, Integer issee, Boolean male, Boolean flag, Date weblogintime, Date weblogouttime, Date forumlastseetime, Date qalastseetime, Long studytermid, Integer status, Long lasttipid, Integer grade, Boolean isfirstlogin) {
        this.id = id;
        this.name = name;
        this.roleid = roleid;
     ...
     *
     * @param forumlastseetime 上一次查看论题消息的时间
     ...
     *
     * @param qalastseetime 上一次查看论题消息的时间
     ...
     *
     * @return grade - 级年 1一年级 2二年级 3三年级 4四年级 5五年级 6六年级 7七年级 8八年级 9九年级 10十年级 11十一年级 12十二年级
     */
     ...
     *
     * @param grade 级年 1一年级 2二年级 3三年级 4四年级 5五年级 6六年级 7七年级 8八年级 9九年级 10十年级 11十一年级 12十二年级
     */
