...
public class BasicInfoController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/termSubject/{id}",method=RequestMethod.GET)
	@ResponseBody
	public ResultJSON getTermSubject(@PathVariable int id) throws  Exception{
		
		return basicInfoServiceImpl.getTermSubject(id);
	}
